...
public class Base64 {
	 ...
	 * </p>
	 * <p>
	 * If data are large, i.e. if you are working with large binary files, consider to use a {@link com.xxs.sdk.util.Base64OutputStream} instead of loading too much data in memory.
	 * </p>
	 * 
	 * @param bytes
	 *            The source sequence.
	 ...
	 * </p>
	 * <p>
	 * If data are large, i.e. if you are working with large binary files, consider to use a {@link com.xxs.sdk.util.Base64InputStream} instead of loading too much data in memory.
	 * </p>
	 * 
	 * @param bytes
