 ...
 * @author xiongxs
 * @date 2014-12-24
 * @introduce 外部继承此适配器使用需要重写getChildView、getGroupView、setTreeHeaderState三个方法，根据具体需求完成实际操作
 */
public class XExpandableViewAdapter extends BaseExpandableListAdapter implements
     ...
     * @param context         上下文
     * @param groups          一级分组内容
     * @param children        二级列表内容
     * @param xExpandableView 自定义的二级展开列表控件
     */
     ...
     * @注意 调用此方法的时候要判断groupPosition>=0并且<groups.size()
     */
    @Override
